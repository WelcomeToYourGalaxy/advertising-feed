#!/usr/bin/env python3
"""
harvest_advertising.py — the advertising wire: how attention is taken, by whom,
using what technique, and under what rules.

After "The Advertising Industries", and following the arc that section traces.
It begins with opinion engineered deliberately — the Creel Committee, Bernays,
the discovery during the First World War that mass desire could be manufactured
— and the psychological technique that followed, including the period when
agencies were described as among the most advanced laboratories in psychology.
Then the export of those techniques worldwide, the deregulation boom, children's
television turned into toy commercials, and tobacco and alcohol marketing that
funded fake research and manufactured doubt for decades.

Then the same thing optimised: behavioural tracking, algorithmic feeds built for
engagement, microtargeting aimed at whoever is most exploitable, and attention
itself as the currency — under, as the section puts it, limited legal protection.
Around that: who owns the agencies, the platforms that sell the space and their
search share, the shaping of what surfaces, green claims that do not hold,
advertising that does not look like advertising, political advertising, AI both
as a tool and as something being steered, advertising in shared space, and
advertising beyond Earth.

A campaign of the week or a creative hire is not this subject. Every subject
term carries the words it must appear beside.

    python3 harvest_advertising.py
    python3 harvest_advertising.py --dry-run
"""
...
# --------------------------------------------------------------------------
USER_AGENT = ("Mozilla/5.0 (compatible; advertising-feed/1.0; "
...
# THE SUBJECTS
#
# How attention is taken, by whom, using what technique, and under what
# rules — from Creel and Bernays through behavioural tracking to space
# billboards.
#
# Each subject is (term, context) pairs. The term must appear AND one of its
# context words, so the trade press cannot reach the wire.
# --------------------------------------------------------------------------
TOPICS = [
    ("propaganda", "Engineering opinion and desire", [
        ("propaganda", ["campaign", "state", "wartime", "history", "technique", "mass"]),
        ("creel committee", []), ("bernays", []), ("public relations", ["origin", "history", "technique", "invented", "pioneer"]),
        ("manufactured consent", []), ("engineering of consent", []),
        ("psychological operation", []), ("psyop", []),
        ("influence campaign", ["state", "covert", "attributed", "coordinated"]),
        ("perception management", []), ("information operation", []),
        ("artificial demand", []), ("manufactured demand", []),
    ]),
    ("psychology", "Psychological technique as method", [
        ("behavioural science", ["advertis*", "marketing", "nudge", "applied", "unit"]),
        ("behavioral science", ["advertis*", "marketing", "nudge", "applied", "unit"]),
        ("nudge", ["unit", "policy", "technique", "criticis*"]),
        ("dark pattern", []), ("deceptive design", []), ("persuasive design", []),
        ("neuromarketing", []), ("emotional targeting", []),
        ("psychographic", []), ("vulnerability", ["exploited", "targeted", "profiling", "consumers"]),
        ("mkultra", []), ("mind control", ["programme", "program", "history", "declassified"]),
        ("addictive design", []), ("compulsion loop", []),
    ]),
    ("children", "Marketing aimed at children", [
        ("marketing to children", []), ("advertising to children", []),
        ("children", ["advert*", "marketing", "targeted", "influencer", "app", "watershed"]),
        ("kidfluencer", []), ("child influencer", []),
        ("watershed", ["advert*", "ban", "junk food", "before 9pm"]),
        ("in-app purchase", ["children", "loot", "regulat*", "refund"]),
        ("loot box", []), ("age-appropriate design", []), ("children's code", []),
        ("toy advertising", []), ("school", ["advert*", "sponsorship", "branded", "marketing"]),
    ]),
    ("harmful", "Tobacco, alcohol, gambling and the rest", [
        ("tobacco advertis*", []), ("tobacco marketing", []), ("vape", ["advert*", "marketing", "flavours", "youth", "ban"]),
        ("e-cigarette", ["advert*", "marketing", "youth", "ban", "promotion"]),
        ("alcohol advertis*", []), ("alcohol marketing", []),
        ("gambling advertis*", []), ("gambling marketing", []), ("betting", ["advert*", "sponsorship", "shirt", "ban"]),
        ("sponsorship", ["tobacco", "alcohol", "gambling", "betting", "banned", "shirt"]),
        ("junk food advertis*", []), ("hfss", []),
        ("promotion ban", []), ("advertising ban", []),
    ]),
    ("doubt", "Funded research and manufactured doubt", [
        ("manufactured doubt", []), ("merchants of doubt", []),
        ("industry-funded", ["research", "study", "science", "campaign", "group"]),
        ("front group", []), ("astroturf*", []),
        ("internal documents", ["tobacco", "industry", "revealed", "disclosed", "leaked"]),
        ("misleading claim*", ["advert*", "marketing", "product", "health", "ruling"]),
        ("false advertising", []), ("deceptive advertis*", []),
        ("disinformation", ["campaign", "commercial", "industry", "paid", "coordinated"]),
    ]),
    ("tracking", "Behavioural tracking", [
        ("behavioural tracking", []), ("behavioral tracking", []),
        ("third-party cookie", []), ("tracking pixel", []), ("fingerprinting", ["browser", "device", "tracking"]),
        ("cross-site tracking", []), ("consent banner", []), ("cookie consent", []),
        ("tracking", ["advert*", "consent", "opt-out", "banned", "ruling", "users"]),
        ("location data", ["sold", "shared", "broker", "advert*", "tracking"]),
        ("device identifier", []), ("advertising id", []), ("idfa", []),
        ("surveillance advertis*", []), ("surveillance capitalism", []),
    ]),
    ("targeting", "Microtargeting and who gets picked out", [
        ("microtargeting", []), ("micro-targeting", []),
        ("behavioural advertis*", []), ("behavioral advertis*", []),
        ("targeted advertis*", []), ("profiling", ["advert*", "consumers", "users", "banned", "ruling"]),
        ("lookalike audience", []), ("custom audience", []),
        ("sensitive categor*", ["targeting", "advert*", "banned", "health", "prohibited"]),
        ("predatory", ["advert*", "marketing", "targeting", "lending", "loans"]),
        ("discriminatory", ["advert*", "targeting", "housing", "employment", "delivery"]),
        ("ad delivery", ["bias", "skew", "discriminat*", "algorithm"]),
    ]),
    ("attention", "Attention, addiction and the feed", [
        ("attention economy", []), ("engagement", ["optimis*", "optimiz*", "maximis*", "maximiz*", "algorithm", "design", "harm"]),
        ("algorithmic feed", []), ("recommendation algorithm", []),
        ("infinite scroll", []), ("autoplay", ["default", "removed", "children", "design"]),
        ("screen time", ["design", "policy", "regulat*", "harm", "children"]),
        ("addictive", ["design", "feed", "platform", "product", "by design"]),
        ("doomscroll*", []), ("attention span", ["research", "decline", "claim", "study"]),
        ("time spent", ["platform", "app", "maximis*", "maximiz*", "metric"]),
    ]),
    ("adtech", "The data supply chain", [
        ("real-time bidding", []), ("programmatic advertis*", []), ("adtech", []),
        ("data broker", []), ("data marketplace", []), ("audience data", ["sold", "shared", "broker"]),
        ("ad exchange", []), ("supply-side platform", []), ("demand-side platform", []),
        ("ad fraud", []), ("click fraud", []), ("made-for-advertising", []),
        ("brand safety", ["failure", "list", "blocklist", "funding"]),
        ("ad spend", ["wasted", "opaque", "audit", "traced", "misplaced"]),
        ("opaque", ["supply chain", "adtech", "programmatic", "fees"]),
    ]),
    ("concentration", "Who owns the industry", [
        ("publicis", []), ("omnicom", []), ("interpublic", []), ("dentsu", []), ("havas", []),
        ("wpp", ["agency", "advert*", "merger", "results", "group"]),
        ("holding company", ["advert*", "agency", "merger", "big six"]),
        ("agency merger", []), ("ad agency", ["merger", "acquisition", "consolidat*", "power", "market"]),
        ("market share", ["advert*", "search", "digital ads", "platform", "dominat*"]),
        ("duopoly", []), ("antitrust", ["advert*", "adtech", "search", "platform", "google", "meta"]),
    ]),
    ("platforms", "The platforms that sell the space", [
        ("google", ["advert*", "adtech", "antitrust", "search share", "ruling", "fine"]),
        ("meta", ["advert*", "targeting", "ruling", "fine", "consent", "antitrust"]),
        ("amazon", ["advert*", "ads business", "ruling", "sponsored"]),
        ("tiktok", ["advert*", "targeting", "children", "ruling", "ban"]),
        ("search engine", ["share", "dominan*", "ruling", "default", "antitrust"]),
        ("default search", []), ("app store", ["advert*", "tracking", "rules", "ruling"]),
        ("sponsored result", []), ("paid placement", []), ("retail media", []),
    ]),
    ("search", "Shaping what surfaces", [
        ("search result", ["manipulat*", "influence", "boost*", "suppress*", "ranking", "lobby*"]),
        ("ranking", ["manipulat*", "boost*", "suppress*", "algorithm", "changed", "penalis*", "penaliz*"]),
        ("seo", ["manipulat*", "spam", "penalt*", "industry", "gaming"]),
        ("reputation management", []), ("review manipulation", []), ("fake review*", []),
        ("shadow ban*", []), ("deranking", []), ("visibility", ["reduced", "suppress*", "algorithm", "downranked"]),
        ("recommendation", ["suppress*", "boost*", "manipulat*", "audit"]),
    ]),
    ("greenwash", "Claims that do not hold", [
        ("greenwash*", []), ("green claim*", []), ("environmental claim*", ["misleading", "banned", "ruling", "unsubstantiated"]),
        ("carbon neutral", ["claim", "banned", "misleading", "ruling", "advert*"]),
        ("net zero", ["claim", "advert*", "misleading", "ruling"]),
        ("sustainab*", ["claim", "misleading", "advert*", "unsubstantiated", "ruling"]),
        ("advertising standards", ["ruling", "upheld", "banned", "complaint"]),
        ("unsubstantiated", ["claim", "advert*", "marketing"]),
        ("washing", ["green", "pink", "sports", "health", "purpose"]),
    ]),
    ("disclosure", "Advertising that does not look like it", [
        ("influencer", ["undisclosed", "advert*", "paid", "rules", "ruling", "marketing"]),
        ("undisclosed", ["advert*", "paid", "sponsorship", "promotion", "partnership"]),
        ("native advertis*", []), ("advertorial", []), ("sponsored content", ["undisclosed", "rules", "labelled", "ruling"]),
        ("product placement", []), ("paid partnership", ["disclos*", "rules", "undisclosed"]),
        ("astroturf review", []), ("ad label*", ["missing", "unclear", "rules", "required"]),
        ("disclosure rules", ["advert*", "influencer", "sponsored"]),
    ]),
    ("political", "Political advertising", [
        ("political advertis*", []), ("political ad", ["spending", "ban", "rules", "transparency", "library"]),
        ("ad library", []), ("issue ad", []),
        ("election advertis*", []), ("campaign advertis*", ["spending", "rules", "ban", "targeting"]),
        ("dark ad", []), ("foreign-funded", ["advert*", "campaign", "political"]),
        ("deepfake", ["advert*", "political", "campaign", "candidate"]),
    ]),
    ("ai", "Automation, generation and steering", [
        ("ai-generated", ["advert*", "content", "image", "campaign", "disclosure"]),
        ("generative ai", ["advert*", "marketing", "content", "agency", "replace"]),
        ("synthetic media", []), ("ai advertis*", []),
        ("ai model", ["contract", "procurement", "neutrality", "bias", "steer*"]),
        ("ideological", ["neutrality", "bias", "requirement", "procurement"]),
        ("procurement", ["ai", "contract", "requirement", "federal", "conditions"]),
        ("chatbot", ["advert*", "sponsored", "recommendation", "monetis*", "monetiz*"]),
        ("training data", ["advert*", "consent", "scraped", "licensed"]),
    ]),
    ("publicspace", "Advertising in shared space", [
        ("billboard", []), ("outdoor advertis*", []), ("out-of-home", ["advert*", "media"]),
        ("digital signage", []), ("advertising ban", ["city", "outdoor", "billboard", "public"]),
        ("public transport", ["advert*", "sponsorship", "naming"]),
        ("naming rights", []), ("stadium", ["naming", "sponsorship", "advert*"]),
        ("public space", ["advert*", "commercial", "sold", "hoarding"]),
        ("street furniture", []), ("light pollution", ["advert*", "signage", "billboard"]),
    ]),
    ("space", "Advertising beyond Earth", [
        ("space billboard", []), ("orbital advertis*", []), ("space advertis*", []),
        ("satellite", ["advert*", "billboard", "brightness", "commercial display"]),
        ("startrocket", []), ("spacebillboard", []),
        ("night sky", ["advert*", "brightness", "satellite", "pollution", "protect*"]),
        ("dark and quiet skies", []),
        ("launch", ["advert*", "billboard", "brand", "stunt", "promotional"]),
    ]),
    ("regulation", "Rules, bans and enforcement", [
        ("advertising regulator", []), ("advertising standards authority", []),
        ("advertising code", []), ("advertising law", []),
        ("gdpr", ["advert*", "consent", "fine", "ruling", "tracking"]),
        ("data protection", ["advert*", "fine", "ruling", "consent", "tracking"]),
        ("dsa", ["advert*", "targeting", "transparency", "obligation"]),
        ("digital services act", []), ("digital markets act", []),
        ("consumer protection", ["advert*", "misleading", "enforcement", "fine"]),
        ("fine", ["advert*", "tracking", "consent", "misleading", "data protection"]),
        ("banned the ad", []), ("upheld the complaint", []),
    ]),
    ("resistance", "What is set against it", [
        ("ad blocker", []), ("adblock*", []), ("tracking protection", []),
        ("opt-out", ["advert*", "tracking", "targeting", "default"]),
        ("global privacy control", []), ("do not track", []),
        ("ad-free", ["subscription", "tier", "option", "model"]),
        ("advertising ban campaign", []), ("subvertis*", []),
        ("campaign", ["advertising ban", "junk food advert*", "gambling advert*", "tracking", "greenwash*"]),
        ("ruling", ["advertising standards", "misleading advert*", "banned the ad"]),
    ]),
]

ANCHOR = [
    # Attention-industry language. A campaign of the week or a creative hire is
    # not this subject; how attention is taken, by whom, using what technique,
    # and under what rules, is.
    "advertising industry", "ad agency", "adtech", "programmatic advertising",
    "real-time bidding", "data broker", "behavioural advertising",
    "behavioral advertising", "targeted advertising", "microtargeting",
    "surveillance advertising", "behavioural tracking", "third-party cookie",
    "tracking pixel", "fingerprinting", "advertising id", "consent banner",
    "dark pattern", "deceptive design", "persuasive design", "neuromarketing",
    "attention economy", "algorithmic feed", "recommendation algorithm",
    "infinite scroll", "addictive design", "marketing to children",
    "advertising to children", "kidfluencer", "junk food advertising",
    "tobacco advertising", "alcohol advertising", "gambling advertising",
    "greenwashing", "green claims", "advertising standards", "misleading claims",
    "false advertising", "native advertising", "advertorial", "product placement",
    "undisclosed", "influencer marketing", "political advertising", "ad library",
    "search result manipulation", "fake reviews", "reputation management",
    "front group", "astroturf", "manufactured doubt", "propaganda",
    "creel committee", "bernays", "mkultra", "ad fraud", "brand safety",
    "billboard", "outdoor advertising", "space billboard", "night sky",
    "digital services act", "digital markets act", "ad blocker",
]

BLOCK = [
    # the trade press, which is most advertising coverage and none of this
    "campaign of the week", "creative director", "chief marketing officer appointed",
    "agency hires", "account win", "pitch win", "new business win",
    "cannes lions", "d&ad", "clio awards", "effie", "awards shortlist",
    "super bowl ad", "christmas advert", "best ads of", "ad of the day",
    "rebrand", "new logo", "brand refresh", "tagline", "jingle",
    "marketing tips", "how to grow your", "boost your engagement",
    "social media strategy", "seo tips", "content calendar",
    # ordinary business coverage
    "quarterly results", "earnings beat", "share price", "market cap",
    "product launch", "store opening", "hiring spree",
    # entertainment and filler
    "film review", "video game review", "recipe", "gift guide", "coupon",
    "black friday", "horoscope", "sponsored post about", "partner content",
]
...
DECIDED = [
    ...
    "fined", "settled", "withdrawn", "suspended", "ordered", "blocked",
    "complaint upheld", "ad banned", "convicted",
]
INSTITUTIONAL = [
    "advertising standards authority", "federal trade commission", "european commission",
    "data protection authority", "information commissioner", "cnil", "noyb",
    "competition and markets authority", "ofcom", "european data protection board",
    "world health organization", "unicef", "oecd", "european parliament",
    ...
    "official data", "government figures", "national statistics", "systematic review",
]
MEASURED = [
    "per cent", "percent", "%", "million", "billion", "trillion",
    "figures show", "fell by", "rose by", "increase of", "decrease of",
    "estimated", "median", "average", "ranked", "index", "share of", "rate of",
    "market share", "ad spend", "impressions", "reach", "users",
]
PENDING = [
...
def run(dry_run=False, fixtures=None):
    ...
    payload = {
        ...
        "languages": languages,
        "standings": [
            {"id": "official", "label": "Regulators, courts & data authorities"},
            {"id": "research", "label": "Research & influence tracking"},
            {"id": "press", "label": "Press"},
            {"id": "rights", "label": "Privacy & consumer organisations"},
        ],
    ...
    if dry_run:
        print("\n--dry-run: wire_advertising.json not written")
        return payload
